...
The project is modified based on Apple sample project "Classfying Images with Vision and Core ML".
A new CoreML model "Image Similarity" was added: https://github.com/apple/turicreate/blob/master/userguide/image_similarity/README.md

The app will use Core ML to find similar images from photo album. Users have the option to pick the best one to save and remove the duplicated/similar photos. 

The goal is to have the app published in the app store with monthly subscription model as well as option for one time purchase. **Generate passive income and retire early!!!**

# Screenshot of existing image removal app from app store
https://itunes.apple.com/us/app/gemini-photos-gallery-cleaner/id1277110040?mt=8
